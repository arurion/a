...
(function() {
    ...
    const css_url = 'https://raw.githubusercontent.com/arurion/a/refs/heads/main/%E3%82%8A%E3%81%AB%E3%82%85%E3%83%BC%E3%81%82%E3%82%8B%E6%98%94%E3%81%AE%E3%82%B5%E3%82%A4%E3%83%88%E9%A2%A8.css';
    fetch(css_url)
      .then(r => r.text())
      .then(t => {
    ...
    // ステップ2: ページに注入するHTMLコンテンツを定義（画像ソースを全て刷新）
        ...
        <tr>
          <td align="center" valign="top">
            <div id="main-contents">
              ...
              <!-- 【変更点】ホットリンク可能なアイコン画像に差し替え -->
              <div class="center-align" style="margin-top: 30px;"><img src="https://i.gifer.com/origin/0c/0c8d9282f53d61085189313936495804_w200.gif" class="icon" alt="回転するアイコン" width="100" height="100"></div>
              <div class="kiriban">キリ番GETしたらBBSに報告してネ！<br>荒らし、誹謗中傷は闇の力で削除します。</div>
              <div class="center-align" style="margin-top: 20px;">
                <p style="color: #ccc;">あなたは悠久の時から数えて</p>
                <!-- 【変更点】リンク切れのカウンターを動くGIFカウンターに差し替え -->
                <img src="https://counter8.fc2.com/counter_img/20121124/1393809.gif" alt="アクセスカウンター">
                <p style="color: #ccc;">番目のお客様です。</p>
              </div>
              <hr style="border: 1px dashed #00FFFF; margin-top: 20px;">
              <div class="center-align" style="margin-top: 20px;">
                 <!-- 【変更点】ホットリンク可能な工事中画像に差し替え -->
